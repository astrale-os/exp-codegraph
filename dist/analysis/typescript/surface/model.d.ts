...
export type ObservedType = {
    ...
    readonly kind: 'array';
    readonly element: ObservedType;
    readonly readonly: boolean;
} | {
    readonly kind: 'record';
    readonly key: ObservedType;
    readonly value: ObservedType;
} | {
    readonly kind: 'tuple';
    ...
    readonly object: ObservedType;
    readonly index: ObservedType;
} | {
    readonly kind: 'object';
    readonly members: readonly ObservedMember[];
} | {
...
export interface ObservedTypeFacet {
    ...
    /** Authored alias RHS retained independently from the stable merged-factory identity view. */
    readonly authoredValueType?: ObservedType;
    readonly location: SourceLocation;
}
...
export type ObservedDeclarationKind = 'value' | 'callable' | 'factory' | 'interface' | 'class' | 'namespace' | 'unsupported';
export interface ObservedDeclaration {
    ...
    readonly valueType?: ObservedType;
    /** Authored type-alias RHS retained independently from its stable semantic identity view. */
    readonly authoredValueType?: ObservedType;
