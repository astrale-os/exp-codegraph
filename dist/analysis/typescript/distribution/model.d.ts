...
export type NativeAnalysisDistributionErrorCode = 'NATIVE_RELEASE_MANIFEST_INVALID' | 'NATIVE_TARGET_UNSUPPORTED' | 'NATIVE_PACKAGE_MISSING' | 'NATIVE_PACKAGE_VERSION_MISMATCH' | 'NATIVE_ARTIFACT_INVALID' | 'NATIVE_ARTIFACT_DIGEST_MISMATCH' | 'NATIVE_ARTIFACT_NOT_EXECUTABLE';
