...
import type { AnalysisGenerationId, FactId, ProjectUniverseId, SnapshotSetId, SourceId, SourceManifestId, SymbolId } from '../identity/index.ts';
...
export interface AnalysisStore {
    ...
    commit(transaction: FactTransaction, options?: {
        readonly signal?: AbortSignal;
    }): Promise<void>;
    open(universe: ProjectUniverseId, generation?: AnalysisGenerationId): Promise<AnalysisQuery>;
    snapshotSet(generations: ReadonlyMap<ProjectUniverseId, AnalysisGenerationId>, inventory: SourceManifestId): Promise<AnalysisSnapshotSet>;
}
