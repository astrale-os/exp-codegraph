...
export { defineState, eventsOf, illegalTransitionsOf, statesOf, transition, transitionsOf, } from './state.ts';
export type { EventOf, IllegalTransition, InitialStateOf, NextStateOf, StateDefinition, StateOf, TerminalStateOf, TransitionOf, TransitionTable, } from './state.ts';
