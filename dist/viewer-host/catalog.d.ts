...
import type { ViewerSpecification as ViewerSpecificationProjection, ViewerSpecificationModule } from './specification.ts';
export declare const CATALOG_INDEX_FORMAT: 'astrale.spec.catalog-index';
export declare const CATALOG_SPEC_FORMAT: 'astrale.spec.catalog-spec';
export declare const CATALOG_SOURCE_FORMAT: 'astrale.spec.catalog-source';
export declare const CATALOG_TRANSPORT_VERSION: 4;
export declare const CATALOG_SPEC_ENDPOINT = "/__astrale/spec-catalog/spec";
export declare const CATALOG_SOURCE_ENDPOINT = "/__astrale/spec-catalog/source";
export declare const HISTORY_RESOURCE_ENDPOINT = "/__astrale/spec-history";
...
export type CatalogSemanticReferenceKind = 'callable' | 'class' | 'factory' | 'interface' | 'member' | 'namespace' | 'unsupported' | 'value';
...
type PackSpecification<Specification extends ViewerSpecificationProjection> = Specification extends unknown ? Omit<Specification, 'modules'> & {
    readonly modules: readonly PackedSpecModule[];
} : never;
...
export declare function catalogSpecMetrics(spec: Pick<ViewerSpecificationProjection, 'diagnostics' | 'verification'> & {
