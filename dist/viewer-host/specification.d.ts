...
import type { BenchmarkResource, CapabilityResource, CodeDeclarationResource, DeclarationResource, ExampleResource, HistoryResource, LawResource, LayoutResource, MarkdownResource, ModuleCodeResource, ModuleIconResource, ModuleSourceReference, PackagePatternResource, PackageSpecificationResource, PortResource, SchemaResource, StateResource } from '../specification/resource/index.ts';
...
export declare function viewerSpecificationDiagnostics(specification: Pick<ViewerSpecification, 'diagnostics'> & {
