...
import type { BenchmarkResource, CapabilityResource, CodeDeclarationResource, DeclarationResource, ExampleResource, LawSpecification, ModuleCodeResource, ModuleSourceReference, PackagePatternResource, PackageSpecificationResource, PortResource, SchemaResource, StateSpecification, TextResource } from '../resource/index.ts';
