import type { AnalysisGeneration, ApplicationModuleBindingWork, ProjectUniverseId, SourceId, SourceRevisionId } from '../../analysis/index.ts';
import type { Diagnostic } from '../../source/diagnostic.ts';
/** Stable fact namespaces for observations adjacent to, but never part of, authored specifications. */
export declare const APPLICATION_LAYOUT_FACT_NAMESPACE: 'astrale.typespec.layout-observation';
export declare const APPLICATION_TEST_FACT_NAMESPACE: 'astrale.typespec.test-evidence';
export declare const APPLICATION_SCHEMA_FACT_NAMESPACE: 'astrale.typespec.schema-catalog';
export declare const APPLICATION_CONTEXT_FACT_NAMESPACE: 'astrale.typespec.module-context';
...
export interface ApplicationLayoutObservationFact {
    ...
    readonly ignore: readonly {
        ...
        readonly source: 'default' | 'layout';
    }[];
