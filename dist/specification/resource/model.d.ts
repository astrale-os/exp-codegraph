...
import type { BenchmarkDefinition, CapabilityDefinition, LawDefinition } from '../../authoring/index.ts';
...
export type LawSpecification = LawDefinition & ExportedDefinition & {
...
export interface ModuleDescriptorResource<Kind extends 'capability' | 'law' | 'state' | 'benchmark', Definition> extends TextResource {
    readonly kind: Kind;
...
export type ModuleSourceResource = ModuleCodeResource | CodeDeclarationResource | CapabilityResource | LawResource | StateResource | BenchmarkResource | LayoutResource;
...
export type SpecificationResource = TextResource | MarkdownResource | ModuleIconResource | HistoryResource;
