...
import type { RepositoryClassification, RepositoryFile, RepositoryInventory } from '../model.ts';
...
export interface RepositoryStatisticsGrouping {
    readonly id: string;
    values(file: RepositoryFile): readonly {
        readonly key: string;
        readonly label?: string;
    }[];
}
export interface RepositoryStatisticsIssue {
    readonly code: 'REPOSITORY_STATISTICS_SOURCE_STALE' | 'REPOSITORY_STATISTICS_SOURCE_UNAVAILABLE' | 'REPOSITORY_STATISTICS_ANALYZER_FAILED';
    readonly source: SourceId;
    readonly path: string;
