export function compileObligations(moduleName, apiPointer, declarations, exports, imports, packages) {
    const obligations = [
    ...
    for (const declaration of declarations.values()) {
        ...
        if ((declaration.identity.kind === 'interface' || declaration.identity.kind === 'class') &&
...
function proofType(type) {
    const expression = type.expression;
    if (expression.kind === 'declaration')
        return proofIdentity(expression.declaration);
