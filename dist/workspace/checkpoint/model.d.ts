...
export type WorkspaceCheckpointArtifacts = ReadonlyMap<string, Uint8Array> | Readonly<Record<string, Uint8Array>> | readonly WorkspaceCheckpointArtifactInput[] | readonly (readonly [string, Uint8Array])[];
...
export type WorkspaceCheckpointMissReason = 'manifest-missing' | 'manifest-unreadable' | 'manifest-too-large' | 'manifest-invalid' | 'artifact-missing' | 'artifact-unreadable' | 'artifact-too-large' | 'artifact-corrupt' | 'artifacts-too-large';
...
export interface FileWorkspaceCheckpointStore {
    ...
    publish(scope: string, input: WorkspaceCheckpointPublishInput, options?: WorkspaceCheckpointOperationOptions): Promise<void>;
    remove(scope: string, options?: WorkspaceCheckpointOperationOptions): Promise<void>;
    dispose(): Promise<void>;
}
export declare const DEFAULT_WORKSPACE_CHECKPOINT_LIMITS: Readonly<{
