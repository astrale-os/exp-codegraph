import type { AnalysisSnapshotSet, AnalysisGenerationId, AnalysisTelemetrySink, NativeAnalysisSessionFactory, NativeModuleBoundary, NativeSourceChange, ProjectUniverseId, RepositoryId, SourceManifestId } from '../../analysis/index.ts';
...
import type { ApplicationObservationRefresh, ApplicationSchemaDependencyResource } from '../observation/index.ts';
...
export interface ApplicationAnalysisWorkspace {
    ...
    open(generations: ReadonlyMap<ProjectUniverseId, AnalysisGenerationId>, inventory: SourceManifestId): Promise<AnalysisSnapshotSet>;
