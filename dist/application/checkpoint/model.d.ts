...
export type ApplicationCheckpointManifestAdmission = {
    ...
    readonly ok: false;
    readonly reason: 'missing' | 'incompatible' | 'unavailable';
};
...
export interface ApplicationCheckpointLoadedContent extends Omit<ApplicationCheckpointContent, 'snapshot'> {
