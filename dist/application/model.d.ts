import type { AnalysisGenerationId, AnalysisQuery, PassId, ProjectUniverseId, RepositoryId, SnapshotSetId, SourceId, SourceManifestId } from '../analysis/index.ts';
import type { QualificationSnapshot } from '../conformance/index.ts';
import type { RepositorySourceRead, RepositorySourceRequest, RepositoryStatisticsReport } from '../repository/index.ts';
...
export type TypeSpecApplicationCapability = 'declaration-models' | 'declaration-navigation' | 'repository-statistics';
