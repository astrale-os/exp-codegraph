...
export function createAnalysisIdentityHash(kind: string, namespace: string) {
  if (!/^[a-z][a-z0-9-]*$/u.test(kind)) throw new TypeError(`Invalid analysis identity kind: ${kind}`)
