...
import type { FactId, PolicyId } from '../../identity/.spec/api.js'
import type { FactSchemaReference } from '../../pass/.spec/api.js'
...
export function runAnalysisPolicies(options: PolicyRunOptions): Promise<PolicyEvaluation>
