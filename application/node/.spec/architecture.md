...
SQLite loads only when the durable store is selected, so importing the application or running
commands that do not open persistence does not initialize the optional database runtime.
