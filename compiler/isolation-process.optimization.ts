...
export function compileApisInIsolatedWorker(
  options: readonly CompileApiOptions[],
  isolation: ApiCompilerProcessOptions,
  ...
  return new Promise((resolve) => {
    ...
    child.on('close', (exitCode, signal) => {
      ...
      let peakResidentBytes: number
      try {
        peakResidentBytes = parseApiCompilerWorkerResourceReport(
